class Config:
    ...
    MESSAGES = {
        ...
        "export_fail_body": "导出过程中发生错误，请按以下信息排查：\n\n1) 错误类型: {error_type}\n2) 错误详情: {error_msg}\n3) 建议排查: 请确认目录写入权限或导出参数是否有效。",  # noqa: E501
    }
    ...
    LAYOUT = {
        ...
        "block_inset_ratio": 0.15,  # 背景块/横线内收比例（以 grid_base 为基准）
    ...
    EXPORT_OPTIONS = {
        ...
        "qualities": ["默认尺寸", "默认尺寸2倍", "默认尺寸3倍", "默认尺寸4倍"],
        "dpis": [72, 96, 150, 200, 300, 600, 1200],
        "colors": ["彩色", "灰度", "黑白"],
        "dir_modes": ["程序目录（导出结果）", "自定义目录"],
    }
