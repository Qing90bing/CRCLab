...
class CRCLabApp:
    ...
    def _setup_window_geometry(self):
        ...
        try:
            ...
            try:  # noqa: SIM105  # fallback chain for window maximize
                # 兼容 Linux X11 环境的最大化
    ...
    def reset_params(self):
        mapping = {
            ...
            "h_spacing": "spacing_var",
            "v_spacing": "v_spacing_var",
            "line_width": "line_width_var",
            "padding": "padding_var",
            "ext_left": "line_ext_left_var",
            "ext_right": "line_ext_right_var",
            "span_left": "curve_span_left_var",
            "span_right": "curve_span_right_var",
            "bold_zeros": "bold_zeros_var",
            "bold_divisor": "bold_divisor_var",
            "bold_quotient": "bold_quotient_var",
            "bold_dividend": "bold_dividend_var",
        }
